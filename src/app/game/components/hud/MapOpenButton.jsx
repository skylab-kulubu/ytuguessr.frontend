    ...
    return (
        ...
        >
            <div className="relative isolate h-23 w-23 rounded-full flex items-center justify-center">
                ...
                <span className="relative z-10 flex h-20 w-20 items-center justify-center rounded-full overflow-hidden backdrop-blur-xl
                   bg-gradient-to-br from-indigo-900/70 to-indigo-900/70 border border-purple-300/20
