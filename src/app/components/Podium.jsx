...
function CountUp({ number, active }) {
    ...
    return (
        ...
        >
            <div className="grid grid-cols-16 items-end w-full h-60">
                {/* 2 */}
                <motion.div
                    className="relative flex-1 col-span-5"
                    initial={{ y: 200, opacity: 0 }}
                    animate={hasEntered ? { y: 0, opacity: 1 } : undefined}
                    transition={{ duration: 1.2, delay: 0.8, ease: [0.25, 0.46, 0.45, 0.94] }}
                >
                    <motion.div
                        className="absolute -top-12 left-2 right-0 text-center"
                    ...
                    <motion.div
                        className="absolute -top-3 left-0 right-0 h-3 bg-gradient-to-br from-indigo-600/70 to-indigo-500/70"
                    ...
                    />
                    <motion.div
                        className="h-36 bg-gradient-to-b from-indigo-900/80 to-indigo-950 shadow-lg border-tl border-indigo-800"
                        initial={{ scaleY: 0 }}
                        animate={hasEntered ? { scaleY: 1 } : undefined}
                        transition={{ duration: 0.8, delay: 0.8 }}
                        style={{ originY: 1 }}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <motion.span
                            className="text-5xl font-bold mb-6 text-white/20"
                            initial={{ scale: 0 }}
                        ...
                        <motion.span
                            className="absolute bottom-2 font-semibold text-white/70"
                            initial={{ y: 20, opacity: 0 }}
                            animate={hasEntered ? { y: 0, opacity: 1 } : undefined}
                ...
                {/* 1 */}
                <motion.div
                    className="relative flex-1 col-span-6"
                ...
                >
                    ...
                    <motion.div
                        className="absolute -top-3 left-0 right-0 h-3 bg-gradient-to-b from-indigo-500/70 to-indigo-400/70"
                    ...
                    />
                    <motion.div
                        className="h-48 bg-gradient-to-b from-indigo-700/70 to-indigo-950 shadow-xl"
                        initial={{ scaleY: 0 }}
                        animate={hasEntered ? { scaleY: 1 } : undefined}
                        transition={{ duration: 1.0, delay: 0.4 }}
                        style={{ originY: 1 }}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <motion.span
                            className="text-6xl font-bold mb-6 text-white/20"
                            initial={{ scale: 0 }}
                            animate={hasEntered ? { scale: 1 } : undefined}
                        ...
                        <motion.span
                            className="absolute bottom-2 text-lg font-semibold text-white/70"
                            initial={{ y: 20, opacity: 0 }}
                            animate={hasEntered ? { y: 0, opacity: 1 } : undefined}
                ...
                >
                    <motion.div
                        className="absolute -top-12 left-0 right-2 text-center"
                        initial={{ y: -20, opacity: 0 }}
                        animate={hasEntered ? { y: 0, opacity: 1 } : undefined}
                    ...
                    <motion.div
                        className="absolute -top-3 left-0 right-0 h-3 bg-gradient-to-bl from-indigo-600/70 to-indigo-500/70"
                    ...
                    />
                    <motion.div
                        className="h-28 bg-gradient-to-b from-indigo-900/80 to-indigo-950 shadow-lg border-tr border-indigo-800"
                        initial={{ scaleY: 0 }}
                        animate={hasEntered ? { scaleY: 1 } : undefined}
                        transition={{ duration: 0.6, delay: 1.2 }}
                        style={{ originY: 1 }}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        ...
                        <motion.span
                            className="absolute bottom-2 text-sm font-semibold text-white/70"
                            initial={{ y: 20, opacity: 0 }}
                            animate={hasEntered ? { y: 0, opacity: 1 } : undefined}
